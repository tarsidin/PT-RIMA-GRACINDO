    ...
    ELSE && ISNULL(THIS.cPattern)
      ...
      *-- Barcode types
          ...
          FOR m.ln = 1 TO THIS.nLenPattern
            ...
            DO CASE
              CASE SUBSTR(THIS.cPattern, m.ln, 1) == "2"
                THIS.oGra.DrawLine(m.lnCol * THIS.nFactor  + THIS.nMargin,  THIS.nMargin, m.lnCol * THIS.nFactor  + THIS.nMargin, m.lnHRH - THIS.nMargin )
              CASE SUBSTR(THIS.cPattern, m.ln, 1) == "1"
                THIS.oGra.DrawLine(m.lnCol * THIS.nFactor + THIS.nMargin, m.lnHRH/1.90, m.lnCol * THIS.nFactor + THIS.nMargin, CEILING(m.lnHRH - THIS.nMargin))
            ENDCASE
          ENDFOR
          ...
          FOR m.ln = 1 TO THIS.nLenPattern
            ...
            DO CASE
              CASE SUBSTR(THIS.cPattern, m.ln, 1) == "A" && Asc
                THIS.oGra.DrawLine(m.lnCol * THIS.nFactor  + THIS.nMargin, THIS.nMargin, m.lnCol * THIS.nFactor  + THIS.nMargin, THIS.nMargin + m.lnFull * .66 )
              CASE SUBSTR(THIS.cPattern, m.ln, 1) == "D" && Desc
                THIS.oGra.DrawLine(m.lnCol * THIS.nFactor + THIS.nMargin, THIS.nMargin + m.lnFull * .33, m.lnCol * THIS.nFactor + THIS.nMargin, m.lnHRH - THIS.nMargin)
              CASE SUBSTR(THIS.cPattern, m.ln, 1) == "T" && Togle
                THIS.oGra.DrawLine(m.lnCol * THIS.nFactor + THIS.nMargin, THIS.nMargin + m.lnFull * .33, m.lnCol * THIS.nFactor + THIS.nMargin, THIS.nMargin + m.lnFull * .66)
          ...
          FOR m.ln = 1 TO THIS.nLenPattern
            ...
            DO CASE
              CASE SUBSTR(THIS.cPattern, m.ln, 1) == "A"
                THIS.oGra.DrawLine(m.lnCol * THIS.nFactor  + THIS.nMargin,  THIS.nMargin, m.lnCol * THIS.nFactor  + THIS.nMargin, (m.lnBarFull + THIS.nMargin) / 2)
              CASE SUBSTR(THIS.cPattern, m.ln, 1) == "D"
                THIS.oGra.DrawLine(m.lnCol * THIS.nFactor + THIS.nMargin, (THIS.nMargin + m.lnBarFull) / 2, m.lnCol * THIS.nFactor + THIS.nMargin, m.lnBarFull)
              CASE SUBSTR(THIS.cPattern, m.ln, 1) == "F"
                THIS.oGra.DrawLine(m.lnCol * THIS.nFactor + THIS.nMargin, THIS.nMargin, m.lnCol * THIS.nFactor + THIS.nMargin, m.lnBarFull)
              OTHERWISE
                * Space
            ENDCASE
          ENDFOR
      ...
      IF THIS.lShowHumanReadableText
        ...
        *-- Clear zone
        m.lnTextMargin = (THIS.nBearerBarWidth + THIS.nQuietZone - 2) * THIS.nFactor + THIS.nMargin
        THIS.oGra.SetBrush(THIS.nBackColor)
        THIS.oGra.SetRect(m.lnTextMargin, THIS.nImageHeight - THIS.nTextHeight - THIS.nMargin, THIS.nImageWidth - m.lnTextMargin * 2, THIS.nTextHeight)
        THIS.oGra.FillRect(m.lnTextMargin, THIS.nImageHeight - THIS.nTextHeight - THIS.nMargin, THIS.nImageWidth - m.lnTextMargin * 2, THIS.nTextHeight)

        DO CASE
          CASE THIS.nBarcodeType = FBC_CODE_EAN13 && EAN-13
            *-- 1st. digit
            m.lnLeft = THIS.nMargin - (2 * THIS.nFactor)
            ...
            *-- 2nd to 7th digit
            m.lnLeft = THIS.nQuietZone * THIS.nFactor + THIS.nMargin
            ...
            *-- 8th to 13th digit
            m.lnLeft = ((THIS.nQuietZone + 46) * THIS.nFactor) + THIS.nMargin
            m.lnRight = 48 * THIS.nFactor
            THIS.oGra.SetBrush(THIS.nBackColor)
            THIS.oGra.SetRect(m.lnLeft, THIS.nImageHeight - THIS.nTextHeight - THIS.nMargin, m.lnRight, THIS.nTextHeight)
            THIS.oGra.FillRect(m.lnLeft, THIS.nImageHeight - THIS.nTextHeight - THIS.nMargin, m.lnRight, THIS.nTextHeight)
            ...
            *-- Supplemental
            IF NOT EMPTY(THIS.cSupplementalText)
              m.lnLeft = (((2 * THIS.nQuietZone) + 91) * THIS.nFactor) + THIS.nMargin
            ...
            *-- Redraw lines
            ...
            FOR m.ln = 1 TO LEN(m.lcBin)
              ...
              IF SUBSTR(m.lcBin, m.ln, 1) = "1"
                THIS.oGra.DrawLine(m.lnCol * THIS.nFactor + THIS.nMargin, THIS.nImageHeight- THIS.nTextHeight - THIS.nMargin, m.lnCol * THIS.nFactor + THIS.nMargin, THIS.nImageHeight- THIS.nTextHeight/2 - THIS.nMargin - 2)
              ENDIF
            ENDFOR
          ...
          CASE THIS.nBarcodeType = FBC_CODE_EAN8 && EAN-8
            ...
            *-- 5th to 8th digit
            m.lnLeft = ((THIS.nQuietZone + 32) * THIS.nFactor) + THIS.nMargin + 1
            m.lnRight = 34 * THIS.nFactor
            THIS.oGra.SetBrush(THIS.nBackColor)
            THIS.oGra.SetRect(m.lnLeft, THIS.nImageHeight - THIS.nTextHeight - THIS.nMargin, m.lnRight, THIS.nTextHeight)
            THIS.oGra.FillRect(m.lnLeft, THIS.nImageHeight - THIS.nTextHeight - THIS.nMargin, m.lnRight, THIS.nTextHeight)
            ...
            *-- Supplemental
            IF NOT EMPTY(THIS.cSupplementalText)
              m.lnLeft = (((2 * THIS.nQuietZone) + 64) * THIS.nFactor) + THIS.nMargin
              m.lnRight = (LEN(THIS.cSupplementalText) + 1) * 9 * THIS.nFactor
              THIS.oGra.SetBrush(THIS.nBackColor)
              THIS.oGra.SetRect(m.lnLeft, THIS.nMargin, m.lnRight, THIS.nTextHeight)
              THIS.oGra.FillRect(m.lnLeft, THIS.nMargin, m.lnRight, THIS.nTextHeight)
          ...
          CASE THIS.nBarcodeType = FBC_CODE_UPCA && UPC-A
            ...
            *-- 2nd to 6th digit
            m.lnLeft = (THIS.nQuietZone + 5) * THIS.nFactor + THIS.nMargin
            ...
            *-- 7th to 12th digit
            m.lnLeft = ((THIS.nQuietZone + 45) * THIS.nFactor) + THIS.nMargin
            m.lnRight = 44 * THIS.nFactor
            THIS.oGra.SetBrush(THIS.nBackColor)
            THIS.oGra.SetRect(m.lnLeft, THIS.nImageHeight - THIS.nTextHeight - THIS.nMargin, m.lnRight, THIS.nTextHeight)
            THIS.oGra.FillRect(m.lnLeft, THIS.nImageHeight - THIS.nTextHeight - THIS.nMargin, m.lnRight, THIS.nTextHeight)
            ...
            *-- 12st. digit
            m.lnLeft = (103 * THIS.nFactor) + THIS.nMargin
            ...
            *-- Supplemental
            IF NOT EMPTY(THIS.cSupplementalText)
              m.lnLeft = (((2 * THIS.nQuietZone) + 92) * THIS.nFactor) + THIS.nMargin
              m.lnRight = (LEN(THIS.cSupplementalText) + 1) * 9 * THIS.nFactor
              THIS.oGra.SetBrush(THIS.nBackColor)
              THIS.oGra.SetRect(m.lnLeft, THIS.nMargin, m.lnRight, THIS.nTextHeight)
              THIS.oGra.FillRect(m.lnLeft, THIS.nMargin, m.lnRight, THIS.nTextHeight)
          ...
          CASE THIS.nBarcodeType = FBC_CODE_UPCE && UPC-E
            *-- 1st. digit
            ...
            THIS.oGra.DrawString(SUBSTR(THIS.cHumanReadableText,1,1), THIS.cFontName, THIS.nFontHeight * 0.85, THIS.cFontStyle)
            *-- 2nd to 6th digit
            m.lnLeft = ((THIS.nQuietZone) * THIS.nFactor) + THIS.nMargin - 1
            m.lnRight = 48 * THIS.nFactor
            THIS.oGra.SetBrush(THIS.nBackColor)
            THIS.oGra.SetRect(m.lnLeft, THIS.nImageHeight - THIS.nTextHeight - THIS.nMargin, m.lnRight, THIS.nTextHeight)
            THIS.oGra.FillRect(m.lnLeft, THIS.nImageHeight - THIS.nTextHeight - THIS.nMargin, m.lnRight, THIS.nTextHeight)
            ...
            THIS.oGra.DrawString(SUBSTR(THIS.cHumanReadableText,2,6), THIS.cFontName, THIS.nFontHeight, THIS.cFontStyle)
            *-- 8th. digit
            m.lnLeft = (60 * THIS.nFactor) + THIS.nMargin - (1 * THIS.nFactor)
            m.lnRight = (THIS.nQuietZone * THIS.nFactor) + (4 * THIS.nFactor)
            THIS.oGra.SetBrush(THIS.nBackColor)
            THIS.oGra.SetRect(m.lnLeft, THIS.nImageHeight - THIS.nTextHeight - THIS.nMargin, m.lnRight, THIS.nTextHeight)
            THIS.oGra.FillRect(m.lnLeft, THIS.nImageHeight - THIS.nTextHeight - THIS.nMargin, m.lnRight, THIS.nTextHeight)
            ...
            *-- Supplemental
            IF NOT EMPTY(THIS.cSupplementalText)
              m.lnLeft = (((2 * THIS.nQuietZone) + 48) * THIS.nFactor) + THIS.nMargin
              m.lnRight = (LEN(THIS.cSupplementalText) + 1) * 9 * THIS.nFactor
              THIS.oGra.SetBrush(THIS.nBackColor)
              THIS.oGra.SetRect(m.lnLeft, THIS.nMargin, m.lnRight, THIS.nTextHeight)
              THIS.oGra.FillRect(m.lnLeft, THIS.nMargin, m.lnRight, THIS.nTextHeight)
  ...
  *------------------------------------------------------
  PROCEDURE Code_128()
    ...
    * Set C = [CHR(48)..CHR(57)] -> [0..9]
    ...
    m.laCod128[100] = "10111011110"
    m.laCod128[101] = "10111101110" && FNC4
    m.laCod128[102] = "11101011110"
